...
if __name__ == '__main__':
    ...
    eager_model = Model(n_heads, n_kv_heads, head_dim, n_proxy_heads, n_proxy_kv_heads, top_k, use_kernel=False).to(DTYPE).to(DEVICE)
    optimized_model = Model(n_heads, n_kv_heads, head_dim, n_proxy_heads, n_proxy_kv_heads, top_k, use_kernel=True).to(DTYPE).to(DEVICE)
